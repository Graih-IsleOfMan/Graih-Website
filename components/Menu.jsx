    ...
    <Popover as="header">
      {({ open }) => (
        <Fragment>
            ...
            >
              <div className="flex items-center flex-1">
                <div className="flex items-center justify-between w-full md:w-auto text-white">
                  <div className="h-12 md:h-16 flex flex-row items-center">
                    <svg
                      className="h-full"
                  ...
                  <div className="-mr-2 flex items-center md:hidden">
                    <Popover.Button className="bg-teal-400 rounded-md p-2 inline-flex items-center justify-center text-slate-400 hover:bg-teal-600 focus:outline-none focus:ring-2 focus-ring-inset focus:ring-white">
            ...
            >
              <div className="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5">
                <div className="px-5 pt-4 flex items-center justify-between">
                  <div className="h-12 md:h-16 flex flex-row items-center text-slate-800">
                    <svg
                      className="h-full"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 28.57 28.108"
                  ...
                  <div className="-mr-2">
                    <Popover.Button className="bg-white rounded-md p-2 inline-flex items-center justify-center text-slate-400 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-teal-600">
          ...
          <Popover.Overlay
            className={`${
              open ? "opacity-60 fixed inset-0 z-20" : "opacity-0"
